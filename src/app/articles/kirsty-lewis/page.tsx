      ...
      <div style={{ position: 'absolute', top: 0, left: 0, width: '100vw', zIndex: 10, color: '#fff', paddingBottom: '100px' }}>
        <div style={{ zIndex: 10 }}>
          ...
          <div className='featured-article-text-section'>
            ...
            <p className='featured-article-paragraph'>I like a lot of the restaurants that are more local, that do really good food. Back in the day, I would want to go to Nobu and all of the other big ones. I’ll do that for work now, but otherwise, I want to go somewhere local. The street food around Peckham and Chiswick - which is near me - is all really nice. Whenever I walk by places like Sexy Fish now, I never get inspired to go in.</p>
            ...
            <p className='featured-article-paragraph'>There have been so many, but one standout was working with John Galliano on the launch of his fragrance. Visiting his atelier in Paris was surreal. Only two PRs had ever been invited inside. It was an incredible experience.</p>
