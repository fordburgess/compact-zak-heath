      ...
      <div className='scroll-container'>
        ...
        <div className='svg-overlay-container' id='desktop-overlay'>
          ...
          <svg version="1.1" viewBox="0 0 4551 2560" preserveAspectRatio="xMidYmid meet" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
            ...
            <g id="layer-interaction">
              <path onClick={() => router.push('/articles/interviews')} data-outline="shelf" fill='rgba(0, 0, 0, 0.01)' data-annotation="Shelf" d="m2236 1388-41.8-24.9-38.4 13.2-37-13.1-11.7-97.9c-6.42-53.8-12.2-104-12.8-112l-1.16-14.5 15.7-44.8 245-100 32 16.2 23.4 217-7.38 20c-4.06 11-7.52 20.5-7.69 21.2s6.85 10 15.6 20.9l15.9 19.7-0.191 18.6c-0.105 10.2-0.432 20-0.727 21.6-0.525 2.94-2.08 3.66-72.1 33.5-39.4 16.8-72.3 30.6-73.2 30.8-0.867 0.143-20.4-11-43.4-24.7z"/>
            </g>
          </svg>
        </div>
      </div>
