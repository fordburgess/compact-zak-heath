    ...
    <div className='featured-article-container'>
      ...
      <div className='featured-article-content'>
        ...
        <div className='featured-article-text-section'>
          ...
          <p className='featured-article-paragraph'>During a really turbulent chapter of my life, I started It's A 10. I had just sold my condo, closed my salon, married, and moved to California. My ex-husband was in sales for Big Sexy Hair, and when he lost his job, we had this moment where we looked at each other and said, "should we start our own brand?"</p>
