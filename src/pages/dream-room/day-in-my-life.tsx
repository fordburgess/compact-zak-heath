  ...
  return (
    <div className='dream-room-article-container'>
      ...
      <div className='dream-room-article-content' ref={verticalScrollRef}>
        <h1 className='dream-room-title'>Day In My Life</h1>
        ...
        <p className='dream-room-paragraph-text'>I’m constantly thinking about the algorithm and how to stay on top of it and I plan out every single hour of my day the night before. It used to feel a bit much, but not doing it actually makes me more stressed. Having an agent has definitely helped. I try to eat well, I’ve actually become a bit of a gym person and I try to read more (emphasis on trying). Life is full-on but I’m happy, healthy and I’m grateful - because without those three things, nothing really else matters.</p>
        <p className='dream-room-paragraph-text'></p>
        <div className='article-image-container'>
          <Image src={Schedule} className="dream-room-profile" alt='profile' />
        </div>
      </div>
    </div>
  )
