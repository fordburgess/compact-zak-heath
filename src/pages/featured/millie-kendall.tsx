    ...
    <div className='featured-article-container'>
      ...
      <div className='featured-article-content'>
        ...
        <div className='featured-article-text-section'>
          ...
          <p className='featured-article-paragraph'>After leaving school at 15, she returned to London to live with her grandparents. She eventually fell in love with New York after visiting at 18 and moving there permanently at 21.</p>
          ...
          <p className='featured-article-paragraph'>Despite the eccentricity, her family wasn't overly interested in her later success in beauty. "My grandmother didn't really understand why I worked so much. She thought I should've stayed home and married. My mum never wore makeup. My dad, though, was a hairdresser - always very groomed. He was more into it than anyone."</p>
          <p className='featured-article-paragraph'>Although her roots were in salons and makeup, Millie never crossed into fashion. "It never appealed to me. I like the smells, the tactility, the packaging. Fashion didn't have that same intimacy. Beauty is housed in beautiful things; you open, close, and hold it. I love that experience."</p>
          <p className='featured-article-subheader'>Her First Venture: Ruby & Millie</p>
          <p className='featured-article-paragraph'>Millie was already working in PR when she met makeup artist Ruby Hammer. "I was her publicist, and she and her husband spent two years convincing me to do the brand with them. I liked my job, had my own business, was making loads of money - I wasn't interested in being the face of a brand."</p>
          <p className='featured-article-paragraph'>Eventually, she agreed. Ruby & Millie launched in 1998 and became one of the UK's most recognisable beauty brands in the late 90s and early 2000s</p>
          <p className='featured-article-paragraph'>"But the moment it launched, I freaked out. My face was suddenly in hundreds of stores. People recognised me at bus stops. It was my worst nightmare. I actually moved to LA to get away from it. That's how much I hated being the front person."</p>
          ...
          <p className='featured-article-paragraph'>The Creator Collective became a training ground for influencers to learn about skin health so they can speak with credibility and authenticity. It was built with the Boots and Walgreens Alliance, which owns several brands, including No7, Liz Earle Beauty Co, Botanics, Soap & Glory, and Sleek MakeUP. "It helps creators, helps brands, and helps the industry." The online course is now open to the public and covers various topics, including misinformation surrounding acne and the dangers of not using SPF.</p>
          <p className='featured-article-subheader'>Recognition For Her Work</p>
          <p className='featured-article-paragraph'>Millie has been honoured with an MBE and OBE for her contributions to the industry. "I got the MBE just after having my daughter. A letter came, and I didn't realise I wasn't supposed to tell anyone, so of course, I told everyone! Then I read the letter properly and realised it wasn't official yet. You have to wait until the honours list is published to see if you're actually on it."</p>
          <p className='featured-article-paragraph'>The OBE came during the pandemic. "By then, I knew how it worked. It was less of a shock but still surreal. William gave it to us. Weird, but amazing."</p>
